    ...
    return (
        <div className={styles.mainContainer}>
            ...
            <div className={styles.container}>
                {action === "Login" ? null : (
                    <IoChevronBackCircle className={styles.backButton} onClick={() => { setAction("Login"); setError(''); }} />
                )}
                ...
                {action === "Forget Password" ? null : (
                    <div className={styles.forgetPassword}>
                        Forgot Password? <span onClick={() => { setAction("Forget Password"); setError(''); }}>Click here!</span>
                    </div>
                )}
